...
<header id="header">
	...
	<% if (UserIdx.equals("")) { %>
		<div class="gnb_member">
			<a href="/member/login.jsp" class="gnb_member_link">로그인</a>
		...
		<% if ("21".equals(UserLevel) || "22".equals(UserLevel)) { %>
			<div class="gnb_member_nav">
				...
				<ul>
					...
					<li><a href="#" onclick="window.open('/manual_html/mainManual.html','pop1','width=850,height=750');">메뉴얼</a></li>
			...
			<ul>
				...
				<li><a href="/store/search_store.jsp">매장찾기</a>
					<ul>
						...
						<li><a href="/store/search_store.jsp">매장찾기</a></li>
					</ul>
				</li>
