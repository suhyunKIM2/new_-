...
section .slider_div{position:absolute;top:50%;left:50%;transform: translate(-50%,-50%);z-index: 9;width:100%;padding-bottom: 129px;margin-top: -7%;}
...
.navbar-default{background-color:rgba(202,41,26,0.7);}
...
.pagingInfo02,.pagingInfo02_1{position:absolute;bottom:-125px;left: 50%;transform: translateX(-50%);color:#000;font-size: 1em;}
.slick-dots{text-align:center;padding-left:0;background: rgba(0,0,0,0.5);padding:0.1% 2%;border-radius: 20px;margin:auto;position:fixed;left:50%;transform: translateX(-50%);bottom: 75px;}
...
.dots{z-index: 9;}
.single-item02 .slick-dots{bottom:-75px;}
.single-item02 .slick-arrow{bottom:-140px;}
...
.container_width{width:95%;margin:0 auto;}
...
.dots li a:before,.dots li a.active:before{background: rgb(0 0 0);}
