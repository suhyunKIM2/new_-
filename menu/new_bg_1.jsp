...
<!--- css여기---->
<style>
    h2.cont_tit {margin: 1.5625em 0 0.875em; font-weight: 600;font-size: 3em;}
    ...
    .t_m_text{text-align: center;font-size:2.2em;margin-bottom:26px;color:#000;}
    .t_m_text>span{color:#DF0003;}
    .t_m_text>br{display:none;}
    @media all and (max-width:883px) {
    .t_m_text{line-height: normal;}
    .t_m_text>br{display: block;}
    }
	...
	@media all and (max-width:500px) {
        ...
        .t_m_text{font-size:20px;}
        h2.cont_tit{font-size:2em;}
	}
    @media all and (max-width:280px) {
    .t_m_text{font-size:18px;}
    }
</style>
...
<body>
	...
	<div id="container" >
		<section id="contents" >
            ...
            <h3 class="t_m_text">드디어 출시! <span>굽네 불금치킨 콤보</span><br> 윙과 통다리를 한번에 즐기세요!</h3>
			...
			<div class="wrap_standard new_menu_wrap" style="margin-top: -10px;">
				...
				<div class="bg_color">
					...
					<img src="/resources/images/contents/menu/bg/211215_bg_02_4.jpg">
				</div>
