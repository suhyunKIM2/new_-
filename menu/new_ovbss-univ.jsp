...
<style>
    ...
    /*한개짜리 버튼 추가*/
    .new_menu_wrap .btn_columbasak {width:100%; background:#7c5438;text-align: center;padding-bottom:8.5%;}
    .new_menu_wrap .btn_order {width:100%; background:#f1efe8;text-align: center;padding-bottom:6.5%;}
    .new_menu_wrap .btn_columbasak img{width:50%;cursor: pointer;}
    .new_menu_wrap .btn_order img{width:50%;cursor: pointer;}
	@media all and (max-width:1250px) {
	.bpset_btn_order{top: 91.6%;}
	}
	@media all and (max-width:1070px) {
	.bpset_btn_order{top: 91.3%;}
	}
	@media all and (max-width:890px) {
	.bpset_btn_order{top: 91%;}
	}
	@media all and (max-width:760px) {
	.bpset_btn_order{top: 92%;}
    .btn_ul{bottom:5em;}
	}
    @media all and (max-width:742px) {
    #wrap{min-width: 280px;}
    .footer_app .app_list li:nth-child(1),.footer_app .app_list li:nth-child(2){margin-bottom:4%;}
    .footer_app .app_list li{width:33%;margin:0;}
    }
	...
	<div id="container" >
		<section id="contents" >
			...
			<div class="wrap_standard new_menu_wrap">
				<!--- S: 본문내용--->
				<div class="bg_color">
					<img src="/resources/images/contents/menu/220511_basasak/img_1.jpg">
					<img src="/resources/images/contents/menu/220511_basasak/img_2.jpg">
					<div class="btn_columbasak">
                        <img src="/resources/images/contents/menu/220511_basasak/btn_columbasak.png" onClick="window.open('https://www.youtube.com/watch?v=c99aYibEys4');">
                    </div>
					<img src="/resources/images/contents/menu/220511_basasak/img_3_3.jpg">
					<div class="btn_order">
                        <img src="/resources/images/contents/menu/220511_basasak/btn_order.png" onClick="window.open('https://order.goobne.co.kr:8481/order/delivery.aspx');">
                    </div>
				</div>
