...
Overseas Business Inquiry</li>
			...
			<div class="overseas_list mt50">
				<ul>
					<li>
							<dl>
								<dt><img src="/resources/images/contents/store/malaysia/detail_img1.jpg" alt="마이타운점"></dt>
								<dd>
									<strong>마이타운점</strong>
									<strong>T. (+60) 3-9201-1042</strong>
									<span>Lot l3-043A,Level 3,Mytown Shopping centre, Cheras,Federal Territory of Kuala Lumpur</span>
								</dd>
							</dl>
                    ...
                    <li>
							<dl>
								<dt><img src="/resources/images/contents/store/malaysia/detail_img2.jpg" alt="수방자야 점 ( SUBANGJAYA )"></dt>
								<dd>
									<strong>수방자야 점</strong>
									<strong>T. (+60) 356121233</strong>
									<span>34, Jalan SS 15/4d, Ss 15, 47500 Subang Jaya, Selangor</span>
								</dd>
							</dl>
                    ...
                    <li>
							<dl>
								<dt><img src="/resources/images/contents/store/malaysia/detail_img3.jpg" alt="라부안 3호점"></dt>
								<dd>
									<strong>라부안 3호점</strong>
									<strong>T.(+60) 173111834</strong>
									<span>Lot 3, Ground Floor, Wisma Lazenda, Jalan Kemajuan, 87008, W.P. Labuan</span>
								</dd>
							</dl>
